...
Публичной бинарной версии пока нет. Официальные подписанные APK и AAB после выхода будут публиковаться через [GitHub Releases](https://github.com/StanleyLl0yd/impulse/releases).
...
Для будущих публичных сборок потребуется Android 8.0 или новее.
