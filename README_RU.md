...
Первый публичный прототип **IMPULSE 0.1.0** доступен в [GitHub Releases](https://github.com/StanleyLl0yd/impulse/releases/tag/v0.1.0): опубликованы подписанные APK и AAB, а также SHA-256 checksums.
