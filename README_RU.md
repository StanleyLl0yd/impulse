...
Текущая версия исходного кода: **0.4.0** (`versionCode 5`) · Min SDK: **26 (Android 8.0)** · Target SDK: **37**
...
Текущая сборка уже образует полноценный локальный игровой цикл: **выбрать уровень, сделать один импульс, получить результат, сохранить прогресс и перейти дальше либо улучшить тот же детерминированный уровень.**
...
Актуальная публичная версия **IMPULSE 0.4.0** доступна в [GitHub Releases](https://github.com/StanleyLl0yd/impulse/releases/tag/v0.4.0): публикуются подписанные APK и AAB, а также SHA-256 checksums.
...
- **Сейчас:** детерминированная кампания из 20 уровней, разблокировка, scoring, звёзды, локальное сохранение, отполированный визуальный/звуковой/тактильный Game Feel и кинематографичный запуск
