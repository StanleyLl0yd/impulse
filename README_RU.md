...
Текущая версия исходного кода: **0.3.0** (`versionCode 3`) · Min SDK: **26 (Android 8.0)** · Target SDK: **37**
...
Актуальный публичный прототип **IMPULSE 0.3.0** доступен в [GitHub Releases](https://github.com/StanleyLl0yd/impulse/releases/tag/v0.3.0): опубликованы подписанные APK и AAB, а также SHA-256 checksums.
