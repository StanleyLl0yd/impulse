...
- Replaced the truncated launcher WebP accidentally published in 1.0.2 with the exact approved 432×432 canonical PNG and uses that PNG directly as the Android launcher foreground.
